...
# Each ModelAdmin is deliberately simple: list_display and raw_id_fields help
# when browsing many related objects in the admin. You can extend these
# classes with search_fields, list_filter, and custom actions as needed.
...
class FoodEntryAdmin(admin.ModelAdmin):
    # raw_id_fields speeds up the admin when the User table is large
